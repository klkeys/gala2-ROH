...
#
# This script computes the overlap of ROH segments between two chr:pos queries in a UCSC BED file.
# The queries are given as "CHR:POS", e.g. "chr1:12345".
# Call:
#     perl roh_overlap.pl ${LOCAL_ANCESTRY_BEDFILE} ${START_QUERY} ${END_QUERY} 
# ========================
