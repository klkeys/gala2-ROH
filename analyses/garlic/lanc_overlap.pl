...
# coded by Zachary Szpiech
#
# This script computes the overlap of local ancestry segments between two chr:pos queries in a UCSC BED file.
# The queries are given as "CHR:POS", e.g. "chr1:12345".
# Call:
#     perl lanc_overlap.pl ${LOCAL_ANCESTRY_BEDFILE} ${START_QUERY} ${END_QUERY} 
# ========================
...
if($#ARGV != 2){
	die "Usage: ./lanc_overlap.pl <lanc bed file> <chr:pos query start> <chr:pos query end>\n";
}
